...
function buildExactRecordQuery(recordStub) {
...
function buildChildrenQuery(recordStub) {
	assert(recordStub.ownerId, "ownerId must be specified");
...
function getRecord(recordStub, includePending = false) {
...
module.exports = {
	MAX_SIZE,
	client,
	buildChildrenQuery, buildExactRecordQuery,
